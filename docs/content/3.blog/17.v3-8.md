...
image:
  src: https://nuxt.com/assets/blog/v3.8.png
authors:
  - name: Daniel Roe
    avatar:
...
::callout{to="https://github.com/nuxt/cli/releases/tag/v3.9.0" icon="i-simple-icons-github" color="gray" target="_blank"}
...
::callout{to="/blog/nuxt-devtools-v1-0" icon="i-simple-icons-github" color="gray"}
...
::callout{to="/docs/guide/directory-structure/layouts#named-layout"}
...
::callout{to="https://vuejs.org/api/reactivity-advanced.html#effectscope" icon="i-simple-icons-vuedotjs" target="_blank"}
...
::callout{to="/docs/guide/going-further/nightly-release-channel#nightly-release-channel"}
...
::callout{to="https://github.com/unjs/nitro/releases/tag/v2.7.0" icon="i-simple-icons-github" color="gray" target="_blank"}
...
::callout{to="https://github.com/nuxt/nuxt/releases/tag/v3.8.0" icon="i-simple-icons-github" color="gray"}
